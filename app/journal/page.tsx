        ...
        <main className="bg-white px-6 py-16 text-text-dark">
            <section className="max-w-4xl mx-auto">
                ...
                <h1 className="text-4xl md:text-6xl font-bold text-fairway-green mb-6">
                    Notes from the ongoing work.
                </h1>
                <p className="text-lg leading-relaxed max-w-2xl">
                    The journal will collect reflections, course notes, practice ideas, and useful lessons from the ongoing
                    work of improving one shot at a time.
                </p>
                ...
                <div className="mt-12 space-y-6">
                    {posts.map((post) => (
                        <article
                            key={post.meta.id}
                            className="border-t border-light-sand pt-6"
                        >
